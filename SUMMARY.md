...
* [廣義線性模型 Generalized Linear Models](Generalized Linear Models/ex3_SGD:Maximum_margin_separating_hyperplane.md)
   * [Ex 3: SGD: Maximum margin separating hyperplane](Generalized Linear Models/ex3_SGD:Maximum_margin_separating_hyperplane.md)
* [模型選擇 Model Selection](Model Selection/ex3_plotting_validation_curves.md)
   * [Ex 3: Plotting Validation Curves](Model Selection/ex3_plotting_validation_curves.md)
   * [Ex 4: Underfitting vs. Overfitting](Model Selection/ex4_underfitting_vs._overfitting.md)
* [半監督式分類法 Semi-Supervised Classification](Semi-Supervised Classification/ex3_Label_Propagation_digits:Demonstrating_performance.md)
   * [Ex 3: Label Propagation digits: Demonstrating performance](Semi-Supervised Classification/ex3_Label_Propagation_digits:Demonstrating_performance.md)
   * [Ex 4: Label Propagation digits active learning](Semi-Supervised Classification/ex4_Label_Propagation_digits_active_learning.md)
